...
import scenariosData from "./data/scenarios.json"; // Adjust the path based on your project structure
...
function AddVehicle() {
  ...
  useEffect(() => {
    setScenarios(scenariosData); // Set scenarios from imported JSON data
  }, []);
  ...
  const handleAdd = async () => {
    ...
    try {
      ...
      // Assuming you would eventually post this data to your backend
